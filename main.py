...
#         length_of_the_day = datetime.datetime.fromtimestamp(data['sys']['sunseet']) - datetime.datetime.fromtimestamp(data['sys']['sunrise'])
#
...
def get_weather(city, weather_tbot):
    ...
    try:
        ...
        if weather_description in code_to_smile:
            ...
            wd = "Посмотри в окноб, не пойму что там"
